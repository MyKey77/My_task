...
//                        this.startSearch(engine);
                    ...
                    case "p"->{
                        //olvassuk be a felhasználótól ID
                        System.out.println("Add meg az ID-t");
                        long pizza_Id=Long.parseLong(sc.nextLine());

                        System.out.println("Add meg a pizza nevét");
                        String pizzaNew=sc.nextLine();

                        System.out.println("ADDIG MEG AZ ÁRÁT ");
                         int id_pizzaar=Integer.parseInt(sc.nextLine());
                        System.out.println(new Pizza(pizza_Id,pizzaNew,id_pizzaar));

                     controll.addPizza(new Pizza(pizza_Id,pizzaNew,id_pizzaar));
